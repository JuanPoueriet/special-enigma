...
- Updated imports in `libs/domain/payroll` to use `@virtex/contracts-payroll-contracts`.
...
- **Better API:** `@virtex/contracts-payroll-contracts` is the clear public API for Payroll data structures.
