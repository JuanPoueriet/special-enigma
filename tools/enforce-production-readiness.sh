...
check_pattern "mock-jwt-token|Create Invoice Flow \(mocked\)" "apps/web/web-portal/src libs -g !**/*.spec.ts -g !**/*.test.ts" "Detected mock UI data markers in runtime GA paths"
