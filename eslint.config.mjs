        ...
        'error',
        {
          ...
          depConstraints: [
            ...
            },
            {
              ...
              onlyDependOnLibsWithTags: ['scope:billing', 'scope:shared', 'scope:kernel', 'scope:subscription', 'scope:fiscal', 'scope:identity', 'scope:catalog', 'scope:platform', 'scope:finops']
            },
            {
