...
import { type ExpensesPort, type ExpenseCategory } from '@virtex/domain-bi-domain';
import { PAYROLL_REPOSITORY, type PayrollRepository } from '@virtex/domain-payroll-domain';
