...
import { BiReport, type BiReportRepository, BI_REPORT_REPOSITORY } from '@virtex/domain-bi-domain';
import { ACCOUNTING_REPORTING_PORT, type IAccountingReportingPort } from '@virtex/domain-accounting-contracts';
