# fiscal-contracts (Contracts)

## 📜 Shared Agreement

This library defines the **Public Contract** for the **Fiscal** domain. It is safe to be shared with other domains or external consumers.
