# projects-presentation (Presentation Layer)

## 🎮 Interface
This library serves as the **Entry Point** for the **Projects** domain. It handles incoming requests (HTTP, GraphQL, Events) and delegates them to the Application layer.
