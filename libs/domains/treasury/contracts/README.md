# treasury-contracts (Contracts)

## 📜 Shared Agreement
This library defines the **Public Contract** for the **Treasury** domain. It is safe to be shared with other domains or external consumers.
