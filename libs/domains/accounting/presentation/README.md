...
This library serves as the **Entry Point** for the **Accounting** domain. It handles incoming requests (HTTP, GraphQL, Events) and delegates them to the Application layer.
