...
## 🌐 Overview
The **Catalog** domain is a core business module of the Virteex ERP system. It follows a strict **Clean Architecture** and **Domain-Driven Design (DDD)** approach, separated into distinct layers to ensure scalability, maintainability, and testability.
