# admin-presentation (Presentation Layer)

## 🎮 Interface
This library serves as the **Entry Point** for the **Admin** domain. It handles incoming requests (HTTP, GraphQL, Events) and delegates them to the Application layer.
